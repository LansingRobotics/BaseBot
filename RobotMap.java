...
public class RobotMap {
    ...
    public static final int ENGAGER = 1;
    ...
    public static final int BACK_ANGLE = 180;
    public static final int AUTONOMOUS_SHOOTING_POWER = 1;
    public static final double AUTONOMOUS_DRIVING_POWER = 0.4;
